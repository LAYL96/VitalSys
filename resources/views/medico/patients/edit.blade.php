<x-app-layout>
    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
            <form action="{{ route('medico.patients.update', $patient) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="dpi" class="w-full mt-1 border rounded p-2"
                            value="{{ old('dpi', $patient->dpi) }}" required>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" rows="3" class="w-full mt-1 border rounded p-2">{{ old('address', $patient->address) }}</textarea>
                    </div>
                </div>
